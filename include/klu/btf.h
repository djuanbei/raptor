...
int btf_maxtrans /* returns # of columns matched */
    (
        ...
        int ncol, int Ap[], /* size ncol+1 */
        int Ai[],           /* size nz = Ap [ncol] */
        double
            maxwork, /* maximum amount of work to do is maxwork*nnz(A); no limit
                      * if <= 0 */
...
UF_long btf_l_maxtrans(UF_long, UF_long, UF_long *, UF_long *, double, double *,
                       UF_long *, UF_long *);
...
UF_long btf_l_order(UF_long, UF_long *, UF_long *, double, double *, UF_long *,
                    UF_long *, UF_long *, UF_long *, UF_long *);
