...
int klu_rgrowth(
    int Ap[], int Ai[], double Ax[], klu_symbolic *Symbolic,
    klu_numeric *Numeric,
...
int klu_z_condest(int Ap[], double Ax[], /* size 2*nz */
                  klu_symbolic *Symbolic, klu_numeric *Numeric,
                  klu_common *Common /* result returned in Common->condest */
                  );
...
int klu_rcond(klu_symbolic *Symbolic, /* input, not modified */
              klu_numeric *Numeric,   /* input, not modified */
              klu_common *Common      /* result in Common->rcond */
              );

int klu_z_rcond(klu_symbolic *Symbolic, /* input, not modified */
                klu_numeric *Numeric,   /* input, not modified */
                klu_common *Common      /* result in Common->rcond */
                );
...
int klu_scale /* return TRUE if successful, FALSE otherwise */
    (
        ...
        int n, int Ap[], /* size n+1, column pointers */
        int Ai[],        /* size nz, row indices */
        double Ax[],
...
UF_long klu_l_scale(UF_long, UF_long, UF_long *, UF_long *, double *, double *,
                    UF_long *, klu_l_common *);

UF_long klu_zl_scale(UF_long, UF_long, UF_long *, UF_long *, double *, double *,
                     UF_long *, klu_l_common *);
...
int klu_extract /* returns TRUE if successful, FALSE otherwise */
    (
        /* inputs: */
        klu_numeric *Numeric, klu_symbolic *Symbolic,
...
UF_long klu_l_extract(klu_l_numeric *, klu_l_symbolic *, UF_long *, UF_long *,
                      double *, UF_long *, UF_long *, double *, UF_long *,
                      UF_long *, double *, UF_long *, UF_long *, double *,
                      UF_long *, klu_l_common *);

UF_long klu_zl_extract(klu_l_numeric *, klu_l_symbolic *, UF_long *, UF_long *,
                       double *, double *, UF_long *, UF_long *, double *,
                       double *, UF_long *, UF_long *, double *, double *,
                       UF_long *, UF_long *, double *, UF_long *,
                       klu_l_common *);
