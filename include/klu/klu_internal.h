...
#define INT_OVERFLOW(x) \
  ((!((x) * (1.0 + 1e-8) <= (double)INT_MAX)) || SCALAR_IS_NAN(x))
...
void KLU_lsolve(
    /* inputs, not modified: */
    Int n, Int Lp[], Int Li[], Unit LU[], Int nrhs,
...
void KLU_usolve(
    /* inputs, not modified: */
    Int n, Int Up[], Int Ui[], Unit LU[], Entry Udiag[], Int nrhs,
...
Int KLU_valid_LU(Int n, Int flag_test_start_ptr, Int Xip[], Int Xlen[],
                 Unit LU[]);
