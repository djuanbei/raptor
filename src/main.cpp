...
int main(int argc, char *argv[]) {
  ...
  randMCF(0, 30000 , 150000 , 300, 10, 4000, 100);
  return 0;
  // testSparse();
  ...
  if (argc ==1) {
    ...
    cout << "case_" << 1500 << "_" << 7500  << ",";
    randMCF(0, 1500, 7500, 300, 10, 1000, 100);
    
    cout << "case_" << 2000  << "_" << 10000 << ",";
    randMCF(0, 2000, 10000, 300, 10, 1000, 100);
    cout << "case_" << 2500  << "_" << 12500 << ",";
    randMCF(0, 2500, 12500, 300, 10, 1000, 100);
    ...
    cout << "case_" << 1500 << "_" << 7500  << ",";
    randMCF(1, 1500, 7500, 300, 10, 1000, 100);
    
    cout << "case_" << 2000  << "_" << 10000 << ",";
    randMCF(1, 2000, 10000, 300, 10, 1000, 100);
    cout << "case_" << 2500  << "_" << 12500 << ",";
    randMCF(1, 2500, 12500, 300, 10, 1000, 100);
    for (int i = 1; i < 40; i += 2) {
    ...
    cout << "case_" << 1500 << "_" << 7500  << ",";
    randMCF(2, 1500, 7500, 300, 10, 1000, 100);
    
    cout << "case_" << 2000  << "_" << 10000 << ",";
    randMCF(2, 2000, 10000, 300, 10, 1000, 100);
    
    cout << "case_" << 2500  << "_" << 12500 << ",";
    randMCF(2, 2500, 12500, 300, 10, 1000, 100);
    for (int i = 1; i < 40; i += 2) {
